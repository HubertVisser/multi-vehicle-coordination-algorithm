...
class s2normConstraintModule(ConstraintModule):
    ...
    def __init__(self, settings, idx):
        ...
        self.constraints.append(s2normConstraintConstraints(settings, idx=idx))
...
class s2normConstraintConstraints:
    ...
    def __init__(self, settings, idx):
        ...
        self.n_sides = 8
        self.n_constraints = (len(self.neighbour_range()) - 1) * 2 # * self.n_sides #2
    ...
    def neighbour_range(self):
        if self.scheme == 'distributed':
            ...
            return range(self.idx, self.number_of_robots+1)
