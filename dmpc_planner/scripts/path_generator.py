...
def raw_track(choice='t_junction', start_x=-5):
    ...
    if choice == 't_junction':
        ...
        checkpoints_x_straight1 = np.linspace(-5, -2, 4)
        ...
        checkpoints_y_straight2 = np.linspace(-2, -4, 4)
        ...
        checkpoints_x_1 = np.linspace(-5, 5, 5)
        checkpoints_y_1 = np.zeros(5)
    
    elif choice == 'straight_line':
        checkpoints_x_1 = np.linspace(start_x, 20, n_checkpoints)
...
def generate_path_msg():
        ...
        checkpoints_x_1, checkpoints_y_1, checkpoints_x_2, checkpoints_y_2 = raw_track(track_choice, start_x)
