...
def open_function(
    ...
    cpp_file,
    function_header,
    optional_header_with_defaults=None,
    class_name="Solver",
    has_type=True,
):
    ...
    if has_type:
        ...
        function_header = class_name + "::" + function_header
...
def add_definition(header_file, definition_name, value):
    header_file.write("#define " + definition_name + " " + str(value) + "\n")